...
import { Activity, BarChart3, Bot, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2, BriefcaseBusiness } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/portfolio", icon: BriefcaseBusiness, label: t('layout.portfolio') },
